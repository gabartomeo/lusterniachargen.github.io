...
$(function() {
    ...
    heading: [
        "Chummers, meet...",
        "My fixer recently told me about...",
		"Mr. Johnson, please take a look at...",
		"I found this one via Jackpoint...",
		"Tonight, the Star is looking for...",
		"Guess who I met tonight..."
    ],
    response: [
        "Surprisingly easy to work with, though. (click here for a new idea)",
        "Hm. Not the right fit? (click here for a new idea)",
        "You need another one for the team? (click here for a new idea)",
		"Now, that's just stupid. (click here for a new idea)",
		"I heard about a run they were on, once... (click here for a new idea)",
		"Can be a bit of a pain, that one. (click here for a new idea)",
		"I don't know why they aren't dead yet. (click here nor a new idea)"
    ],
    template: [
